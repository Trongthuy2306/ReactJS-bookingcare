...
class VerifyEmail extends Component {
    ...
    async componentDidMount() {
        if (this.props.location && this.props.location.search) {
            let urlParmas = new URLSearchParams(this.props.location.search);
            let token = urlParmas.get('token');
            let doctorId = urlParmas.get('doctorId');
    ...
    render() {
        ...
        console.log('check state booking email:', this.state);
        return (
            <>
                <HomeHeader />
