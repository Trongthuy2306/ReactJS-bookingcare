...
class BookingModal extends Component {
    ...
    handleConfirmBooking = async () => {
        ...
        console.log('check user booking confirm:', this.state)
    }
            ...
            >
                <div className='booking-modal-content'>
                    ...
                    <div className='booking-modal-footer'>
                        ...
                        <button className='btn-booking-cancel' onClick={closeBookingClose}><FormattedMessage id='patient.booking-modal.btnCancel' /></button>
                    </div>
                </div>
            </Modal>
